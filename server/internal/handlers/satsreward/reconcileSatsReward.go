...
var ReconcileSatsReward = func(c *fiber.Ctx) error {
	...
	log.Printf("Sats reward reconciliation initialized: %s", satsReward.ID)

	return c.Status(fiber.StatusOK).JSON(fiber.Map{
		"status":  "success",
		"message": "Sats reward reconciliation initialized!",
		"data":    satsReward,
	})
}
