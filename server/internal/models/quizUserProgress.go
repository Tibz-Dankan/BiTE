...
func (qup *QuizUserProgress) FindAllByUser(userID string, limit float64, cursor string) ([]QuizUserProgress, error) {
	var quizUserProgress []QuizUserProgress
	...
	query.Where("\"userID\" = ?", userID).Find(&quizUserProgress)
