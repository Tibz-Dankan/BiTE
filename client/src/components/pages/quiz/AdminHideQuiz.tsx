...
import { HideQuizForm } from "../../ui/quiz/HideQuizForm";

export const AdminHideQuiz: React.FC = () => {
    ...
    <div className="w-full mb-16 space-y-8 mt-8">
      <div className="w-full">
        ...
        <p className="text-sm text-gray-600 mt-2">
          Hide this quiz from students: {quiz.title}
        </p>
      </div>
      <div className="w-full max-w-2xl">
        <HideQuizForm quiz={quiz} onSuccess={handleSuccess} />
      </div>
    </div>
  );
};
