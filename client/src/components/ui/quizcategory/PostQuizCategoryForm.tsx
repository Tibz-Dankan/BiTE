...
import type { TPostQuizCategory } from "../../../types/quizCategory";
...
interface PostQuizCategoryFormProps {
  onSuccess: (succeeded: boolean) => void;
}

export const PostQuizCategoryForm: React.FC<PostQuizCategoryFormProps> = (
  props
) => {
  ...
  const { isPending, mutate } = useMutation({
    mutationFn: quizCategoryAPI.post,
  ...
  const initialValues: TPostQuizCategory = {
    name: "",
    color: "",
    file: null,
  };
