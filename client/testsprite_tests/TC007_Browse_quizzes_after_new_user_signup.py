...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to /auth/signup to begin creating a new test account.
        await page.goto("http://localhost:5173/auth/signup")
        
        # -> Fill the signup form (name, unique email, password, confirm password), toggle the acceptance checkbox, and submit the form.
        ...
        # -> Fill the Confirm Password field, toggle the newsletter/terms checkbox, and submit the Sign Up form to create the account.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the 'Quizzes' sidebar link to open the quizzes page and verify the quizzes list is displayed.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/aside/div/div[3]/nav/div[2]/a').nth(0)
        await asyncio.sleep(3); await elem.click()
